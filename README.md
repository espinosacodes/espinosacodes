...
| [TalkTown](https://github.com/espinosacodes/zero-to-agent) | AI-powered language learning RPG built at Vercel's Zero to Agent hackathon — explore a town, chat with AI NPCs, practice languages | Next.js, React, Vercel AI SDK, TypeScript, DynamoDB, Tailwind | [Live Demo](https://zero-to-agent.vercel.app) |
...
| **Last Updated** | April 24, 2026 07:57 UTC |
<!-- DAILY-UPDATE:END -->
