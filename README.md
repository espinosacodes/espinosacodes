...
| [TalkTown](https://github.com/espinosacodes/zero-to-agent) | AI-powered language learning RPG — explore a town, chat with AI NPCs, practice languages | Next.js, React, Vercel AI SDK, TypeScript, DynamoDB, Tailwind | [Live Demo](https://zero-to-agent.vercel.app) |
